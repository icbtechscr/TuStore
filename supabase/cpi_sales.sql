-- Ventas de CPI (appcontadorcpi.com) sincronizadas hacia TuStore.
...
-- Compatibilidad con instalaciones creadas antes de incorporar la exclusión
-- de vendedores. La sincronización descubre el padrón propio de TuStore.
